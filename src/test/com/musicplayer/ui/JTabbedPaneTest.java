...
public class JTabbedPaneTest extends BasicTabbedPaneUI {
	...
	public JTabbedPaneTest() {
		...
		//new Color(233,237,248);//选中的最上层
		selectedColorSet.topGradColor1 = new Color(255, 0, 0);
		// new Color(158,199,240);//选中的第二层
		selectedColorSet.topGradColor2 = new Color(225, 225, 30);
		// new Color(112,173,239);//选中的第三层
		selectedColorSet.bottomGradColor1 = new Color(225, 225, 30);
		// new Color(183, 244, 253);//选中的最下层
		selectedColorSet.bottomGradColor2 = new Color(255, 0, 0);
		defaultColorSet = new ColorSet();
		// new Color(253,253,253);//未选的最上层
		defaultColorSet.topGradColor1 = new Color(73, 50, 205);
		// new Color(237,237,237);
		defaultColorSet.topGradColor2 = new Color(0, 255, 255);
		// new Color(222,222,222);
		defaultColorSet.bottomGradColor1 = new Color(0, 255, 255);
		// new Color(255,255,255);
		defaultColorSet.bottomGradColor2 = new Color(73, 50, 205);
		hoverColorSet = new ColorSet();
		// new Color(244,244,244);//鼠标在的时候最上层
		hoverColorSet.topGradColor1 = new Color(245, 245, 10);
		// new Color(223,223,223);
		hoverColorSet.topGradColor2 = new Color(237, 18, 117);
		// new Color(211,211,211);
		hoverColorSet.bottomGradColor1 = new Color(5, 232, 255);
		// new Color(235,235,235);
		hoverColorSet.bottomGradColor2 = new Color(19, 236, 40);
		maxTabHeight = 21;
		setContentInsets(1);
	}
