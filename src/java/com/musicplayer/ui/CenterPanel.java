...
import com.musicplayer.util.Mp3Util;
...
public class CenterPanel extends JPanel {
	...
	public CenterPanel(JFrame frame, SouthPanel southPanel) {
		...
		setOpaque(false);
		fload = new FileDialog(frame, "打开文件", FileDialog.LOAD);
	}
	...
	public void initLeftMenu() {
		...
		// cellRender.setLeafIcon(new ImageIcon(Constant.pre2));
		...
		leftmenu.setCellRenderer(new DefaultTreeCellRenderer() {
			...
			public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded,
				...
				/*
				 * if("本地音乐".equals(nodename)){ icon.setImage(Constant.pre2);
				 * }else if("下载管理".equals(nodename)){
				 * icon.setImage(Constant.next2); }else
	...
	public void initContent() {
		...
		JPanel center = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				//g.drawImage(Constant.splash, 0, 0, null);
			}
		};
